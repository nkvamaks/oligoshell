...
nucleotide_extinction_260 = {'dA': 15400, 'dC': 7400,  'dG': 11500, 'dT': 8700,
                             ...
                             'dB': 9200,  'dD': 11867, 'dH': 10500, 'dV': 11433,
                             'dN': 10750,
...
# https://www.sigmaaldrich.com/technical-documents/articles/biology/quantitation-of-oligos.html
# dint_extinction_DNA_260 = {'AA': 27400, 'AC': 21200, 'AG': 25000, 'AT': 22800,
...
def extinction_dna_simple(sequence):
    """Takes sequence as a collection e.g. tuple and calculates extinction coefficient of non-modified
    single-stranded oligodeoxynucleotides containing degenerate bases"""

    extinction = 0
    for nucleotide in sequence:
        extinction += {**nucleotide_extinction_260, **modification_extinction_260}[nucleotide]
    return extinction
...
def calc_mass_avg(sequence):
    ...
    m_avg -= mass_avg['H2O'] * (len(sequence_split(sequence))-1)
    return round(m_avg, 2)


def calc_mass_monoisotopic(sequence):
    """
    ...
    m_mono -= mass_mono['H2O'] * (len(sequence_split(sequence))-1)
